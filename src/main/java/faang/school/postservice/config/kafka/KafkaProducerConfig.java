...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, EventDto> producerFactory() {
        ...
        configProducerProps.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaProperties.getAddress());
    ...
    public NewTopic postViewKafkaTopic() {
        return new NewTopic(kafkaProperties.getTopicsNames().getView(), 1, (short) 1);
    }
